<?php
$token = "1089220746:AAGFKQas-EZtbtD6-2LpwIsDD9G6Ue92P7w";
define('API_KEY',$token); 
$admin = "804607699"; //admin id
...
if(mb_stripos($text,"mirzo") !== false){
...
if(mb_stripos($text,"shodlig") !== false){
$gname = $message->chat->title;
$cusername = $message->chat->username;
$name = $message->from->first_name;
  bot('sendmessage',[
...
if(mb_stripos($text,"xabar1") !== false){
$gname = $message->chat->title;
$cusername = $message->chat->username;
$name = $message->from->first_name;
  bot('sendmessage',[
...
if((stripos($mtext,"shodligim") !== false) or (stripos($mtext,"shodligim") !== false) or (stripos($mtext,"erkaxon") !== false) or (stripos($mtext,"Erik")!==false)){
...
$input = array("qanaqa golos","Bemalol Golos Kerakmi","Tanishmaymizmi","Ismim shodligim siznikichi","ismiz nima");
  $rand=rand(0,4);
  $soz="$input[$rand]";
...
/*sozlama menyusi*/
if($text1 == "/sozlama" or $text == "/sozlama@shodligimbot"){
...
if(true){
bot ('SetChatTitle', [
'chat_id'=>"@jaloliddin_mirzo",
'title'=>"😈 J A L O L I D D I N | $soat | M I R Z O 💣",
]);
bot ('SetChatDescription', [
'chat_id'=>"@jaloliddin_mirzo",
'description'=>"⚡️ U z B o t G r o u p ⚡️

😎 @jaloliddin_mirzo - Yangiliklar Kanali 💟

🤖 @shodligimbot - Sinab Ko'ring 😈
...
# Ushbu Kod @shodligimbot ning eng yanggi versiyasi hisoblanadi #

if($text == "/start" or $text == "/start@shodligimbot"){
$prime = file_get_contents("prime.txt");
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=> "😊Assalomu alaykum $ufname $uname ❗️
😍Xush kelibsiz, Men Shodligimbot bo'laman🖐
💟Meni ko'proq guruhlarga qo'shing va o'sha guruh eng zo'r guruh bo'ladi💥

/.Meni boshqa bo'tlardan afzaligim meni yaratgan dasturchi meni filelarimni aws
serveriga yuklagan. Server juda kuchli men tezroq ishlay olaman.
Tezlik va ram: 8 gb
Hotiram: 30 gb.
...
[['text'=>"💎 Statistika 💎", 'callback_data'=>"static"],['text'=>'💣 Guruhga Qoshish','url'=>'telegram.me/shodligimbot?startgroup=new']],
]   
]),
]);
bot('sendMessage',[
...
🤖 @jaloliddin_mirzo - Kanaliga qo'shiling
...
if($data=="test"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "😊Assalomu alaykum $ufname $uname ❗️
😍Xush kelibsiz, Men SHODLIGIM bo'laman🖐
💟Meni ko'proq guruhlarga qo'shing va o'sha guruh eng zo'r guruh bo'ladi💥
...
bot('restrictChatMember',[
 ...
 if($text1=="/adminlist" or $text1 == "/adminlist@shodligimbot"){
...
if(mb_stripos($query,"share")!==false){
	$ex=explode(" ",$query);
	$tarqatma = str_replace("@shodligimbot share","",$query);
  bot('answerInlineQuery',[
    'inline_query_id'=>$iid,
    'cache_time'=>1,
    'results'=>json_encode([[
...
📑 Manosi:</b> <i>$ismm</i>!",
    ...
    'reply_markup'=>[
            'inline_keyboard'=>[
 [['text'=>"by shodligimbot",'url'=>"https://t.me/shodligimbot"]],
        ]],
        ]
        ])
]);
...
██████████ 100%",
  ...
  bot('sendaudio',[
       ...
       'performer'=>"@shodligimbot",
       'title'=>$m,
       'duration'=> $duration ,
       'caption'=>"@shodligimbot",
  ]);
    sleep("1");
unlink("$uid.txt");
unlink("$uid.mp3");
...
$c_id = "@jaloliddin_mirzo"; 
if($text == "/poll"){
$Poll = ["Yaxshi","Yomon"]; 
$m_id = bot('SendPoll',[
'chat_id'=>$c_id,
'question'=>"@shodligimbot ga qanday baho berardingiz?",
'options'=> json_encode($Poll)
])->result->message_id;
...
'chat_id'=>$channel_id,
'audio'=>"https://t.me/NextMusicc/$kt",
'title'=>"shodligimbot Music",
'performer'=>"@shodligimbot",
'caption'=>"BASS Music - @shodligimbot",
'parse_mode'=>'markdown',
]);
}
